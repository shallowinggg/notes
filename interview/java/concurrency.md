...
![](/images/java/13068256-5068a578fc4cac1e.webp)
...
### 读写锁
![read-write](/images/java/rwlock.png)
...
![state](/images/java/stamped-lock.png)
...
![StampedLock-write](/images/java/StampedLock-write.png)
...
![StampedLock-read](/images/java/StampedLock-read.png)
...
![image.png](/images/java/threadpool.webp)
...
![](/images/java/sq-stack-lock.png)

![](/images/java/sq-stack-unlock.png)

##### 公平

使用队列作为数据结构，先进先出。

![](/images/java/sq-queue-lock.png)

![](/images/java/sq-queue-unlock.png)

### LongAdder

虽然`AtomicInteger`, `AtomicLong`等提供原子更新的能力，但是当在高并发的场景下会存在大量线程自旋，导致CPU消耗过多且还是无效执行。而`LongAdder`则缓解了这个问题，它是基于分段锁的思想实现的：

![LongAdder](/images/java/LongAdder.png)
